                ...
                <table class="table align-items-center table-flush">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                           {{mb_substr(($soal->pertanyaan),3,20)}}...
                        </td>
                        <td>
                            {{mb_substr(($soal->a),0,10)}}...
                        </td>
                        <td>
                            {{mb_substr(($soal->b),0,10)}}...
                        </td>
                        <td>
                            {{mb_substr(($soal->c),0,10)}}...
                        </td>
                        <td>
                            {{mb_substr(($soal->d),0,10)}}...
                        </td>
                        <td>
                            {{mb_substr(($soal->e),0,10)}}...
                        </td>
                        
                        <td>
                          <span class="badge badge-dot mr-4">
                            <i class="bg-warning"></i> {{$soal->kunci}}
                          </span>
                        </td>
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                              <a class="dropdown-item" href="{{url("listsoal/edit/$soal->id")}}">Edit</a>
