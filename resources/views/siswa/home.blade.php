            ...
            <section class="blog_section" id="blog_section">
              <div class="container"data-aos="fade-up" data-aos-delay="100" >
                  <div class="blog_content">
                      <h3 style="-webkit-text-fill-color: rgb(248, 109, 59)">List Bacaan</h3> <hr>
                      ...
                      <div class="owl-carousel owl-theme">
                          <div class="blog_item filter-nasional" data-aos="fade-up" data-aos-delay="100">
                              ...
                              <div class="blog_details">
                                  <div class="blog_title">
                                      <h5><a href="/tabloid">1. Sebelum Pertempuran Karang Kedawung, Pasukan Brigade III/Damarwulan...</a></h5>
                                  </div>
                                  <ul>
                                      <li><i class="icon ion-md-person"></i>Zahira</li>
                                      <li><i class="icon ion-md-calendar"></i>1 Maret 2022</li>
                                  </ul>
                          ...
                          <div class="blog_item"data-aos="fade-up" data-aos-delay="200">
                              ...
                              <div class="blog_details">
                                  <div class="blog_title">
                                      <h5><a href="/tabloid2">2. Berperang Melawan Belanda Di Karang Kedawung Pasca Kemerdekaan</a></h5>
                                  </div>
                                  <ul>
                                    <li><i class="icon ion-md-person"></i>Zahira</li>
                                    <li><i class="icon ion-md-calendar"></i>1 Maret 2022</li>
                                  </ul>
                                  <p style="text-indent: 0">Merdeka, satu kata yang umumnya kita pahami dengan arti kebebasan. Proklamasi yang di...</p>
                          ...
                          <div class="blog_item"data-aos="fade-up" data-aos-delay="300">
                              ...
                              <div class="blog_details">
                                  <div class="blog_title">
                                      <h5><a href="/tabloid3">3. Yuk Uji Pemahaman Kalian Tentang Pertempuran Karang Kedawung</a></h5>
                                  </div>
                                  <ul>
                                    <li><i class="icon ion-md-person"></i>Zahira</li>
                                    <li><i class="icon ion-md-calendar"></i>1 Maret 2022</li>
