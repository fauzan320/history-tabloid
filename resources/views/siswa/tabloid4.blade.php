                ...
                <div class="carousel-inner ">
                    ...
                    <div class="row no-gutters">
                      ...
                      <div  class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        ...
                        <div style="padding-bottom: 0px" class="section-title text text-left" data-aos="fade-up" data-aos-delay="100">
                          <br>
                          <h3 >MENGENAL LEBIH DEKAT KOMANDAN BRIGADE III/DAMARWULAN, LETKOL. MOCHAMMAD SROEDJI</h3>
                          <hr>
                        </div>
                        <!-- paragraf 1 -->
                      ...
                      <!-- gambar -->
                      <div style="margin-top: -4 rem; text-align: center " class="col-lg-10 video-box about-content" data-aos="fade-up" data-aos-delay="200">
                        <br>
                  ...
                  <div class="carousel-item">
                    ...
                    <div class="row no-gutters">
                      ...
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        <div class="text-justify" data-aos="fade-up" data-aos-delay="200">
                          <p style="margin-bottom: 0rem;text-indent: 0" class="description">
                          Sroedji mulai terjun dibidang militer ketika bersekolah di Peta (Pembela Tanah Air) Bogor untuk calon <i>shudanco</i> (komandan kompi), dan bergabung di Kompi I di bawah arahan Letnan. Nomura Shohichi. Setelah tuntas bersekolah di sana, Sroedji ditugaskan di Daidan II Besuki untuk wilayah Jember–Banyuwangi dengan pangkat <i>shudanco</i>.
                          </p>
                        </div>
                      </div>
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        ...
                        <div class="text-justify" data-aos="fade-up" data-aos-delay="200">
                          <p style="margin-bottom: 0rem;text-indent: 0" class="description">
                          Setelah Proklamasi Kemerdekaan, Sroedji bergabung dalam Resimen II/BKR berpangkat mayor. Ketika BKR berganti nama TKR, secara otomatis Resimen II/BKR beralih menjadi Resimen IV/TKR Divisi VIII. Adapun peranan batalyon Sroedji saat itu adalah ikut serta mempertahankan wilayah tengah Sidoarjo saat pihak Sekutu memberikan ultimatum pada tanggal 9 November 1945. Dari insiden tersebut keesokan harinya meletus sebuah pertempuran di Surabaya yang dikenal dengan Pertempuran 10 November.
                          </p>
                        </div>
                      </div>
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                      ...
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        <div class="text-justify" data-aos="fade-up" data-aos-delay="200">
                          <p style="margin-bottom: 0rem;text-indent: 0" class="description">
                          Agresi Militer I Belanda berakhir melalui Perundingan <i>Renville</i>. Dampak dari perundingan tersebut menyebabkan setiap pasukan TNI melakukan hijrah ke wilayah Republik, termasuk pasukan Sroedji yang melakukan hijrah ke Blitar. Di sisi lain, dampak dari Perundingan <i>Renville</i> menyebabkan jatuhnya Kabinet Amir Sjariffudin dan digantikan oleh Kabinet Hatta. Semasa Kabinet Hatta, kebijakan terkenal yang diberlakukannya adalah melakukan Rasionalisasi dan Reorganisasi Angkatan Perang (Rera) termasuk TNI.
                          </p>
                        </div>
                      </div>
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                  ...
                  <div class="carousel-item">
                    ...
                    <div class="row no-gutters">
                      ...
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        <div class="text-justify" data-aos="fade-up" data-aos-delay="200">
                          <p style="margin-bottom: 0rem;text-indent: 0" class="description">
                          Setelah gerakan PKI Madiun dinilai benar-benar berakhir, program Rera yang sempat tertunda kembali dilanjutkan. Hingga akhirnya diputuskan Brigade Mobil Damarwulan dilebur menjadi Brigade III/Damarwulan Divisi I Jawa Timur dengan komandan brigade III, Letkol. Mochammad Sroedji. Markas Brigade III/Damarwulan berlokasikan di Blitar. 
                          </p>
                        </div>
                      </div>
                      <!-- paragraf 3 -->
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        <div class="text-justify" data-aos="fade-up" data-aos-delay="200">
                          <p style="margin-bottom: 0rem;text-indent: 0" class="description">
                          Saat Agresi II Belanda, Brigade III/Damarwulan bersama segenap batalyonnya melakukan gerakan <i>wingate</i> kembali ke Besuki. Namun, sayangnya ketika para staf Brigade III tiba di Desa Karang Kedawung, terjadi pertempuran dengan tentara KNIL.
                          </p>
                        </div>
                      </div>
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                      ...
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        <div class="text-justify" data-aos="fade-up" data-aos-delay="200">
                          <p style="margin-bottom: 0rem;text-indent: 0" class="description">
                          Pertempuran Karang Kedawung yang berlangsung pada tanggal 8 Februari 1949 menyebabkan gugurnya Sroedji karena tertembak. Gugurnya komandan Brigade III tersebut dimanfaatkan oleh Belanda sebagai media propaganda untuk menghancurkan mental pasukan lainnya yang masih tersisa. Jenazah Sroedji diletakkan di ruang terbuka oleh Belanda di pelataran Hotel Djember. 
                          </p>
                        </div>
                      </div>
                      <!-- gambar -->
                  ...
                  <div class="carousel-item ">
                    ...
                    <div class="row no-gutters">
                      ...
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        <div class="text-justify" data-aos="fade-up" data-aos-delay="200">
                          <p style="margin-top: 2rem; margin-bottom: 0rem;text-indent: 0" class="description">
                          Melihat kondisi tersebut, salah satu tokoh dari Kreongan bernama Kiai Dachnan menyelamatkan jenazah Sroedji pada tanggal 9 Februari 1949. Setelah melalui diskusi panjang dengan Belanda, Kiai Dachan berhasil membawa jenazah Sroedji untuk dimakamkan secara terhormat di TPU Tunjung, Kreongan. Atas jasanya Sroedji dinobatkan sebagai Bintang Mahaputera pada tanggal 3 November 2016 yang tertera dalam Keppres RI No. 91/TK/Tahun 2016 semasa pemerintahan Presiden Joko Widodo.
                          </p>
