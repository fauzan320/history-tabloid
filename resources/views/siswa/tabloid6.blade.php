                ...
                <div class="carousel-inner ">
                  <div class="carousel-item active">
                    ...
                    <div class="row no-gutters">
                      ...
                      <!-- gambar -->
                      <div style=" margin-top: -2rem; text-align: center" class="col-lg-10 video-box" data-aos="fade-up" data-aos-delay="200">
                        <br>
                      ...
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        <div class="text-justify" data-aos="fade-up" data-aos-delay="200">
                          ...
                          Nama dr. Soebandi saat ini diabadikan sebagai nama tempat fasilitas yang bergelut dibidang kesehatan, seperti SMK Farmasi dr. Soebandi bahkan RSUD dr. Soebandi yang sama-sama berlokasikan di Kecamatan Patrang, Kabuputen Jember. Tahukah kalian? Sebenarnya Soebandi adalah seorang dokter yang ikut berperang bersama Sroedji di Karang Kedawung?
                          </p>
                  ...
                  <div class="carousel-item">
                    ...
                    <div class="row no-gutters">
                      ...
                      <div class="col-lg-10 d-flex flex-column justify-content-center about-content">
                        <div class="text-justify" data-aos="fade-up" data-aos-delay="200">
                          <p style="margin-bottom: 0rem;text-indent: 0" class="description">
                          Dr. Soebandi terjun dalam bidang militer ketika secara resmi menjadi <i>ease shodanco</i> dokter tentara Peta Daidan Lumajang pada tanggal 27 Desember 1943. Setelah Peta dibubarkan, dr. Soebandi tetap bertugas menjadi dokter di RSUD Probolinggo. 
                          </p>
                        </div>
                      </div>
