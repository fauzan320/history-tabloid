                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        {{-- <li class="nav-item dropdown">
                          ...
                          <li class="nav-item dropdown">
                            <a style="color: white" class="nav-link dropdown-toggle" data-toggle="dropdown" href="{{route('ourproduct_page_admin')}}" role="button" aria-haspopup="true" aria-expanded="false">Gallery</a>
                            <div class="dropdown-menu">
